...
const citiesApi = "dataBase/cities.json",
  API_KEY = "dca5590983f17fb740b98e861edff8c0",
...
const createCard = (data) => {
  ...
  if (data) {
    ...
    deep = '<h3>К сожалению на текущую дату билетов не обнаружено</h3>'
  }
...
formSearch.addEventListener("submit", event => {
  ...
  alert ('Введите пожалуйста корректное название города!');
}
});
